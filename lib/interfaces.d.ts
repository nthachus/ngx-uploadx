...
export declare type RequestHeaders = Record<string, Primitive | Primitive[]>;
export declare type Metadata = Record<string, Primitive | Primitive[]>;
...
export declare type UploadAction = 'upload' | 'cancel' | 'pause';
...
export declare type UploaderClass = new (file: File, options: UploaderOptions, stateChange: (evt: UploadState) => void, ajax: Ajax) => Uploader;
