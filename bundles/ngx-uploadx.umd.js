(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-uploadx', ['exports', 'rxjs', 'rxjs/operators', '@angular/core'], factory) :
    (factory((global['ngx-uploadx'] = {}),global.rxjs,global.rxjs.operators,global.ng.core));
    ...
    ***************************************************************************** */
    ...
    /** @type {?} */
    var UPLOADX_AJAX = new i0.InjectionToken('uploadx.ajax', {
        factory: ( /**
         * @return {?}
    ...
    var b64 = {
         ...
         */function (encoded) {
            ...
            try {
                ...
                try {
                    if (kvPairs_1_1 && !kvPairs_1_1.done && (_a = kvPairs_1.return))
                        _a.call(kvPairs_1);
                }
                finally {
                    if (e_1)
                    ...
                    return __generator(this, function (_f) {
                        switch (_f.label) {
                            ...
                            case 1:
                                ...
                                _f.label = 2;
                            case 2:
                                if (!(this.status === 'uploading' || this.status === 'retry'))
                                    return [3 /*break*/, 19];
    ...
    /** @type {?} */
    var UPLOADX_FACTORY_OPTIONS = new i0.InjectionToken('uploadx.factory.options', { providedIn: 'root', factory: ( /**
             * @return {?}
             */function () { return defaultOptions; }) });
    /** @type {?} */
    var UPLOADX_OPTIONS = new i0.InjectionToken('uploadx.options');
    ...
    var UploadxService = /** @class */ (function () {
        function UploadxService(options, defaults, ajax, ngZone, idService) {
            ...
            if (typeof window !== 'undefined') {
                this.subs.push(rxjs.fromEvent(window, 'online').subscribe(( /**
                 * @return {?}
                 */function () { return _this.control({ action: 'upload' }); })), rxjs.fromEvent(window, 'offline').subscribe(( /**
                 * @return {?}
         ...
         */
            function (options) {
                var _this = this;
                return this.init(options).pipe(operators.startWith(null), operators.map(( /**
                 * @return {?}
                 */function () { return _this.queue; })), operators.debounceTime(DUE_TIME));
            };
        /**
        ...
        /** @nocollapse */
        UploadxService.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [UPLOADX_OPTIONS,] }] },
                { type: undefined, decorators: [{ type: i0.Inject, args: [UPLOADX_FACTORY_OPTIONS,] }] },
                { type: undefined, decorators: [{ type: i0.Inject, args: [UPLOADX_AJAX,] }] },
                { type: i0.NgZone },
                { type: IdService }
            ];
        };
        /** @nocollapse */ UploadxService.ngInjectableDef = i0.defineInjectable({ factory: function UploadxService_Factory() { return new UploadxService(i0.inject(UPLOADX_OPTIONS, 8), i0.inject(UPLOADX_FACTORY_OPTIONS), i0.inject(UPLOADX_AJAX), i0.inject(i0.NgZone), i0.inject(IdService)); }, token: UploadxService, providedIn: "root" });
    ...
    var UploadxDirective = /** @class */ (function () {
        ...
        UploadxDirective.decorators = [
            { type: i0.Directive, args: [{ selector: '[uploadx]' },] }
        ];
        /** @nocollapse */
        UploadxDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: i0.Renderer2 },
                { type: UploadxService }
        ...
        UploadxDirective.propDecorators = {
            uploadx: [{ type: i0.Input }],
            options: [{ type: i0.Input }],
            control: [{ type: i0.Input }],
            state: [{ type: i0.Output }],
            fileListener: [{ type: i0.HostListener, args: ['change', ['$event.target.files'],] }]
        };
    ...
    var UploadxDropDirective = /** @class */ (function () {
        ...
        UploadxDropDirective.decorators = [
            { type: i0.Directive, args: [{ selector: '[uploadxDrop]' },] }
        ];
        /** @nocollapse */
        UploadxDropDirective.ctorParameters = function () {
            return [
                { type: UploadxService }
            ];
        };
        UploadxDropDirective.propDecorators = {
            active: [{ type: i0.HostBinding, args: ['class.uploadx-drop-active',] }],
            fileInput: [{ type: i0.ContentChild, args: [UploadxDirective,] }],
    ...
    exports.UploadxAjax = UploadxAjax;
    exports.UPLOADX_AJAX = UPLOADX_AJAX;
    exports.Tus = Tus;
    ...
    exports.UPLOADX_FACTORY_OPTIONS = UPLOADX_FACTORY_OPTIONS;
    exports.UPLOADX_OPTIONS = UPLOADX_OPTIONS;
